...
export interface GuardianInterface extends utils.Interface {
  functions: {
    ...
    "setConfigQuoteParam(address[],(uint128,uint16,uint16,uint8,uint128)[])": FunctionFragment;
    ...
    "setInstrumentQuoteParam(address[],(uint128,uint16,uint16,uint8,uint128)[])": FunctionFragment;
